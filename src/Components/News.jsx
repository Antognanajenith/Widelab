  ...
  return (
   ...
   {!simplified && (
     <>
      ...
      <div class="flex justify-center">
        <div class="mb-3 xl:w-96">
          <select class="form-control w-72 px-3 py-1.5 text-base font-normal text-whiter1 bg-darkgreyer rounded-sm transition ease-in-out
    ...
    {Newslistdatum.value.map((news,i)=>(
        <div className={`flex  ${simplified?'w-[28rem]':'w-80'} bg-white rounded-lg flex-col  hover:drop-shadow-2xl transition ease-in-out  duration-450`} key={i}>
